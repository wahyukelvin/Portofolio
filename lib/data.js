...
export const DATA = {
  profile: {
    ...
    address: "Perum Soka Asri, Blok M No. 1, Kadisoka, Sleman, DIY",
    ...
    photoCut: "/images/profile-cutout.png",
    ...
    stats: [
      ["3,69", "IPK dari 4,00"],
      ["20+", "Booth ekspo dipresentasikan"],
      ["5.000+", "Pertumbuhan pengikut organik"],
  ...
  organizations: [
    ...
    },
    {
      ...
      title: "Duta Universitas (UAJY Ambassador)",
      icon: "megaphone",
      status: "Aktif",
    ...
    {
      year: "2023",
      title: "Relawan Pelatihan Aplikasi Notion",
      icon: "book",
      status: "Selesai",
  ...
  projects: [
    {
      kind: "Sistem Informasi Pemerintahan",
    ...
    {
      kind: "Riset & Evaluasi Sistem",
      title: "Evaluasi Kualitas Layanan SIKN — PIECES Framework & IPA",
      desc:
    ...
    },
    {
      ...
      title: "Automation Testing Playground — Katalon Studio & Cypress",
      desc:
    ...
    },
    {
      ...
      title: "Dashboard Analitik Penerimaan Mahasiswa",
      desc:
    ...
    {
      kind: "UI/UX Design",
      title: "Redesain Antarmuka Layanan Kearsipan",
      desc:
  ...
  papers: [
    ...
    },
    {
      year: "2026",
      title:
        "Evaluasi Layanan Kualitas Sistem Informasi Kearsipan Nasional (SIKN) Berbasis Persepsi Pengguna Menggunakan PIECES Framework dan Importance-Performance Analysis",
      meta: "Skripsi — Program Studi Sistem Informasi, Universitas Atma Jaya Yogyakarta · Nilai A−",
      desc:
        "Penelitian kuantitatif terhadap persepsi pengguna SIKN. PIECES Framework digunakan untuk memetakan performance, information, economics, control, efficiency, dan service; hasilnya dipetakan pada kuadran Importance-Performance Analysis untuk menentukan prioritas perbaikan.",
      preview: "",
      link: ""
    },
    {
      year: "2021",
      title: "Karya Tulis Ilmiah Biologi — Juara 1 Tingkat Provinsi Kalimantan Timur",
      meta: "Lomba Karya Tulis Ilmiah tingkat Provinsi · juga meraih Best Innovation",
      desc:
        "Karya tulis ilmiah bidang biologi yang meraih Juara 1 sekaligus penghargaan Best Innovation di tingkat provinsi.",
      preview: "",
      link: ""
    },
    {
      year: "Lorem",
      title: "Artikel: Lorem ipsum dolor sit amet",
      meta: "Tambahkan artikel Medium / LinkedIn / jurnal Anda di sini",
      desc:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ganti bagian ini dengan artikel atau tulisan Anda berikutnya, lengkap dengan tautan publikasinya.",
      preview: "",
      link: ""
    },
    {
  ...
  achievements: [
    {
      date: "Mei 2024",
      title: "Best Presenter — KONSTELASI 2024",
      issuer: "Seminar Nasional & Konferensi Teknologi Informasi, UAJY",
      img: "",
      desc:
        "Penghargaan untuk presenter terbaik pada Seminar Nasional & Konferensi Teknologi Informasi KONSTELASI 2024, dinilai dari penguasaan materi, struktur penyampaian, dan interaksi dengan audiens."
    },
    {
      date: "Maret 2023 — Agustus 2026",
      title: "Duta Universitas Atma Jaya Yogyakarta",
      issuer: "Universitas Atma Jaya Yogyakarta",
      img: "",
      desc:
        "Terpilih sebagai Duta UAJY yang mewakili universitas pada kegiatan promosi, penerimaan tamu institusi, dan acara kemitraan — peran yang menuntut kemampuan komunikasi publik dan representasi institusi."
    },
    {
      date: "2021",
      title: "Juara 1 Lomba Karya Tulis Ilmiah Biologi",
      issuer: "Tingkat Provinsi Kalimantan Timur",
      img: "",
      desc:
        "Juara pertama pada lomba karya tulis ilmiah bidang biologi tingkat provinsi, dengan penelitian yang disusun dan dipresentasikan bersama tim sekolah."
    },
    {
      date: "2021",
      ...
      img: "",
      desc:
        "Penghargaan Best Innovation atas gagasan penelitian yang dinilai paling inovatif pada lomba karya tulis ilmiah biologi tingkat provinsi."
    },
    {
      date: "2021",
      ...
      img: "",
      desc:
        "Juara Harapan 1 pada lomba karya tulis ilmiah bidang kimia tingkat provinsi Kalimantan Timur."
    },
    {
      date: "2022",
      title: "Nilai kelulusan SMA 86,94/100",
      issuer: "SMA Katolik W.R. Soepratman 020 Samarinda — Jurusan MIPA",
      img: "",
      desc:
        "Menyelesaikan pendidikan menengah atas di jurusan MIPA dengan nilai kelulusan 86,94 dari 100, sambil aktif di paduan suara, badminton, dan tim desain sekolah."
    }
  ],
  ...
  documentation: {
    sma: [
      { img: "", caption: "Tim Desain PPDB — SMAK W.R. Soepratman" },
      { img: "", caption: "Presentasi Karya Tulis Ilmiah Biologi" },
      { img: "", caption: "Paduan Suara SMAK Armonia Choir" },
      { img: "", caption: "Latihan Badminton Club" },
      { img: "", caption: "Penyerahan Juara 1 Tingkat Provinsi" },
      { img: "", caption: "Kegiatan pengelolaan media sosial sekolah" }
    ],
    kuliah: [
      { img: "", caption: "Booth ekspo penerimaan mahasiswa baru" },
      { img: "", caption: "Kepengurusan HIMSI periode 2022/2023" },
      { img: "", caption: "Innovation Week Fest — panitia IT" },
      { img: "", caption: "KKN 87 Unit H — Padukuhan Klepu I" },
      { img: "", caption: "Presentasi KONSTELASI 2024" },
      { img: "", caption: "Sesi kerja SIMARSITA bersama tim kearsipan" },
      { img: "", caption: "Wisuda Sistem Informasi UAJY" }
    ]
  },
